...
To this end only students are allowed into the student work area except with
temporary organizer permission. Anyone else is forbidden from touching the
robots or their code, especially for repairs, changes, programming.
